...
export const ModelTooltipContent = memo(({ model }: ModelTooltipContentProps) => {
	...
	return (
		<div className="max-w-xs p-2">
			<div className="font-bold text-[14px] mb-1 text-tooltip-foreground">
				{model.displayName || model.name}
			</div>

			{model.description && (
				<div className="text-[12px] text-tooltip-foreground">
					{model.description}
				</div>
			)}
			...
			<div className="text-[11px] flex flex-col gap-2.5">
				<div className="flex justify-between mt-4 items-center">
					<span className="text-tooltip-foreground/70">Vendor:</span>
					<span className="font-medium text-tooltip-foreground">
						{model.vendor}
					</span>
				</div>

				<div className="flex justify-between gap-4 items-center">
					<span className="text-tooltip-foreground/70">Context:</span>
				...
				<div className="flex justify-between gap-4 items-center">
					<span className="text-tooltip-foreground/70">Max tokens:</span>
					<span className="text-tooltip-foreground">
				...
				<div className="flex justify-between gap-4 items-center">
					<span className="text-tooltip-foreground/70">Prompt:</span>
					<span className="text-tooltip-foreground">
				...
				<div className="flex justify-between gap-4 items-center">
					<span className="text-tooltip-foreground/70">Completion:</span>
					<span className="text-tooltip-foreground">
				...
				{isReasoning && (
					<div className="flex flex-row items-center gap-2 text-brand text-center mt-2">
