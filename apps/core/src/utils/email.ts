 ...
 * umlaut used to fail registration outright. `z.regexes.unicodeEmail` is the pattern that
 * accepts them.
 *
 ...
 * with a trailing space, and `unicodeEmail` excludes whitespace -- validating first would
...
export const emailSchema = z
	...
	.pipe(z.email({ pattern: z.regexes.unicodeEmail, message: "Invalid email address" }));
